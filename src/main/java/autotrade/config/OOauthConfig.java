...
import autotrade.v1.exception.RestTemplateResponseErrorHandler;
import autotrade.v1.oauth.AccessTokenService;
import autotrade.v1.oauth.AppController;
import autotrade.v1.oauth.CustomRestTemplate;
import autotrade.v1.oauth.RequestTokenService;
...
import autotrade.v1.oauth.AuthorizationService;

@EnableWebSecurity
@Configuration
@PropertySource("classpath:oauth.properties")
@ComponentScan(basePackages = { "autotrade.*" })
